...
describe("Page Structure", () => {
    ...
    it("loads all the subtitles' divs", () => {
        ...
        cy.get(".subtitle-content .subtitle-segment").should("have.length", countOfSampleDotSrtSubtitles);
    });
        ...
        cy.get(".subtitle-content")
            ...
            .then(($segments) => {
                ...
                cy.window().then((win) => {
                    ...
                    cy.log(`Data has ${dataCount} segments, rendered ${renderedCount} divs`);
                });
            });
    });
});
