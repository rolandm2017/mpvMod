import type { SubtitleSegmentObj } from '../src/routes/+page.server';

export interface MockData {
	subtitleTimestamps: number[];
	segments: SubtitleSegmentObj[];
...
export const mockSubtitleData: MockData = {
	...
	subtitleCuePointsInSec: [
		4.874, 24.685, 30.732, 39.022, 43.868, 54.554, 59.059, 59.904, 60.789, 83.09, 92.359, 96.142,
		97.243, 100.046, 105.591, 109.475, 112.503, 113.586
	],
	timecodes: [
